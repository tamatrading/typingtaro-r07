...
import { Heart, Trophy, Volume2, VolumeX, Settings } from 'lucide-react';
...
const TypingGame: React.FC<Props> = ({ settings, onAdminRequest }) => {
  ...
  }, [settings.selectedStages, startCountdown]);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-2xl p-8 bg-gradient-to-b from-blue-100 to-blue-200 shadow-xl rounded-lg">
        <div className="text-center mb-4">
          <div className="flex justify-between items-center mb-2">
            ...
            <h1 className="text-2xl font-bold">typingTaro r07</h1>
